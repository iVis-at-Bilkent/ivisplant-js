    ...
    var cyOptions = {
      ...
      ready: function ()
      {
        ...
        cy.on('cxttap', 'node', function (event) {
          ...
          var between = cy.elements().betweennessCentrality();


          str = str + "Closeness = " + closeness.toFixed(4)
                  + "\nNormalized Closeness = " + normalizedCloseness.closeness_n('#' + node.id()).toFixed(4)
                  + "\nBetweenness = " + between.betweenness('#' + node.id())
                  + "\nNormalized Betweenness = " + between.betweenness_n('#' + node.id()).toFixed(4);
          alert(str);
